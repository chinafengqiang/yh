...
public class DES {
	/** 加密、解密key. */  
    private static final String IV = "yhndesiv";
    ...
    static {
        DES_KEY = ResourceBundle.getValue("des.secret.key");
    }
    ...
    public final static String encrypt(String data) throws Exception  {
        return byte2hex(encrypt(data.getBytes(), DES_KEY
                .getBytes()));
    }
    ...
    * @return 返回DES解密后的数据  
    ...
    public static void main(String[] args){
    	DES des = new DES();
    	try {
            String str = encrypt("yh2016");
            System.out.println(str);
            String dtr = decrypt(str);
